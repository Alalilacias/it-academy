...
import S1.T5.n1.exercise3.src.classes.DirectoryReaderAuxiliary2;

public class MainS1n1e3 {
    public static void main(String[] args) {
//        Check that there's two arguments, arguably the paths. Remind user of instructions if not.
        if (args.length != 2) {
            System.out.println("To use this file, the correct command is as follows: java MainS1n1e3.java <directory_path> <output_path>");
            System.exit(1);
        }
...
//        Execute DirectoryReader() method.
        DirectoryReaderAuxiliary2.DirectoryReader(directoryPath, savePath);
