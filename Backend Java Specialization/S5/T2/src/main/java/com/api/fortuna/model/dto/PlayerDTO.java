 ...
 * @param roles of the user. <br>In this implementation of the app, it's always going to be a single role.
 * @param winRate of the user. <br>Always available, without having to use a specific method.
 */
